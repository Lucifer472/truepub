...
import View1 from "@/components/views/partners-and-brand/view-1";
import View2 from "@/components/views/partners-and-brand/view-2";
import View3 from "@/components/views/partners-and-brand/view-3";

export const PartnersAndBrandView = () => {
  ...
  return (
    <div className="w-full h-full bg-background-green relative">
      ...
      <div className="absolute bottom-6 xl:top-[35%] right-[5%] transition-all duration-700">
        <div className="hidden xl:flex flex-col items-center justify-center">
          <div className="flex flex-col items-end justify-end gap-y-0 w-full">
            <h2 className="text-[5rem] leading-[1em] font-extralight">.05</h2>
            <span className="text-yellow-400 leading-[1em] font-medium text-[1.2rem]">
              PARTNERS & BRANDS
            </span>
            <div className="h-[2px] w-[220px] mt-4 flex">
              <span
