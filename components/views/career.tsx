...
import View1 from "@/components/views/career/view-1";
import View2 from "@/components/views/career/view-2";
import View3 from "@/components/views/career/view-3";
      ...
      >
        <div className="hidden xl:flex flex-col items-center justify-center">
          <div className="flex flex-col items-end justify-end gap-y-0 w-full">
            <h2 className="text-[5rem] leading-[1em] font-extralight">.06</h2>
            <span className="text-yellow-400 leading-[1em] font-extralight text-[2rem]">
              Career
            </span>
            <div className="h-[2px] w-[150px] mt-4 flex">
              <span
