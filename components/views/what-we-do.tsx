...
import View1 from "@/components/views/what-we-do/view-1";
import View2 from "@/components/views/what-we-do/view-2";
import View3 from "@/components/views/what-we-do/view-3";
...
export const WhatWeDoView = () => {
  ...
  return (
    <div className="w-full h-full bg-background-purple relative">
      ...
      <div className="absolute bottom-6 xl:top-[35%] right-[5%] transition-all duration-700">
        <div className="hidden xl:flex flex-col items-center justify-center">
          <div className="flex flex-col items-end justify-end gap-y-0 w-full">
            <h2 className="text-[5rem] leading-[1em] font-extralight">.03</h2>
