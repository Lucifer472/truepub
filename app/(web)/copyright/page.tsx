...
export const metadata: Metadata = {
  title: "Copyright | True Pub Media Solution",
};
    ...
    <div className="w-full flex flex-col max-w-[90%] md:max-w-[80%] mx-auto gap-y-4 text-black">
      ...
      <div className="flex flex-col items-start gap-y-2">
        ...
        <p className="font-extralight text-xs md:text-sm text-justify">
          ...
          internet. The results that are displayed by TRUE PUB MEDIA as result
          of a search command of a user, originate from other search engines.
          TRUE PUB MEDIA shows the source of each result in its result list. It
          is possible that TRUE PUB MEDIA shows in the search results direct
          ...
          can be found and accessed by using the Website, TRUE PUB MEDIA does
          ...
          copy and / or download of this material. TRUE PUB MEDIA is never
          ...
          provided by TRUE PUB MEDIA.
        </p>
      </div>
      <div className="flex flex-col items-start gap-y-2">
        <span className="text-sm md:text-base">
          Trademarks / trade names in advertisement on TRUE PUB MEDIA -
          Sponsored links
        </span>
        <p className="font-extralight text-xs md:text-sm text-justify">
          TRUE PUB MEDIA displays several advertisements on different pages of
          its website. TRUE PUB MEDIA acknowledges the intellectual property
          rights of third parties. TRUE PUB MEDIA also displays sponsored links
          ...
          may not be displayed in the sponsored links of TRUE PUB MEDIA, TRUE
      ...
      <div className="flex flex-col items-start gap-y-2">
        <span className="text-sm md:text-base">
          Trademarks / trade names in advertisement on TRUE PUB MEDIA - Other
          advertisements
        </span>
        <p className="font-extralight text-xs md:text-sm text-justify">
          ...
          rights to, TRUE PUB MEDIA kindly requests you to inform TRUE PUB MEDIA
          about this via this form. TRUE PUB MEDIA shall assess your complaint
      ...
      <div className="flex flex-col items-start gap-y-2">
        <span className="text-sm md:text-base">
          Trademarks / trade names in advertisement of TRUE PUB MEDIA on the
          internet
        </span>
        <p className="font-extralight text-xs md:text-sm text-justify">
          TRUE PUB MEDIA advertises in the internet at several advertisement
          ...
          When you are of the opinion that advertisements of TRUE PUB MEDIA
          infringe upon intellectual property rights that belong to you or your
          company or to which your company can claim rights to, TRUE PUB MEDIA
          kindly requests you to inform TRUE PUB MEDIA about this via this form
          or in writing to 501,Kabir Shilp, Kudasan, Gandhinagar, India -
          382124. TRUE PUB MEDIA shall assess your complaint and – if necessary
